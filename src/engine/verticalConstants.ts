...
export const LAVA_HAZARD_HP_PER_SEC = 24;
export const LAVA_HAZARD_INSTABILITY_PER_SEC = 15;
export const LAVA_HAZARD_TICK_S = 0.1;
export const LAVA_AIRBORNE_IMMUNITY_Z = 2;
export const LAVA_SURFACE_H_DRAG = 3.5;
