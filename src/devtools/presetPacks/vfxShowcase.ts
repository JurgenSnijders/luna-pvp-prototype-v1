...
export const VFX_SHOWCASE_PRESETS: Record<string, AbilitySchema> = {
  'Prism Lance': {
    ...
    triggers: [{ trigger: 'ON_HIT', actions: [{ type: 'ADD_INSTABILITY', amount: 15, target: 'TARGET' }] }],
  },
  'Void Rift Bomb': {
    id: 'vfx_void_rift',
    name: 'Void Rift Bomb',
    ...
    triggers: [{ trigger: 'ON_HIT', actions: [{ type: 'ADD_INSTABILITY', amount: 25, target: 'TARGET' }] }],
  },
  'Rune Nova': {
    id: 'vfx_rune_nova',
    name: 'Rune Nova',
    ...
    triggers: [{ trigger: 'ON_HIT', actions: [{ type: 'SPAWN_FIELD', field: { fieldType: 'RADIAL_IMPULSE', radius: 90, strength: 800, durationMs: 500 } }] }],
  },
  'Plasma Fork': {
    id: 'vfx_plasma_fork',
    name: 'Plasma Fork',
    ...
    triggers: [{ trigger: 'ON_HIT', actions: [{ type: 'ADD_INSTABILITY', amount: 12, target: 'TARGET' }] }],
  },
};
