...
import {
  ...
  fetchLLMPassive,
  postNativeGemini,
} from './synthesizer/geminiClient';
import {
  deepNormalizeLLMValue,
  repairAbilityPayload,
  tryParseLLMJson,
} from './synthesizer/llmRepair';
...
import { COMPILER_SYSTEM_PROMPT } from './synthesizer/prompts';
import { getAiSettings } from './synthesizer/settings';
import {
  getLastApiError,
  setLastSynthesisError,
  setLastSynthesisSource,
} from './synthesizer/status';
