...
SPAWN_FIELD: MUST nest configuration inside a "field" object — NEVER put fieldType/radius/strength/durationMs at the action root, and NEVER use "falloff" (engine computes distance falloff automatically):
  { "type": "SPAWN_FIELD", "field": { "fieldType": "MASS_ATTRACTOR"|"RADIAL_IMPULSE"|"VORTEX_TANGENT"|"FRICTION_OVERRIDE", "radius": number, "strength": number, "durationMs": number, "attachToSource"?: boolean, "frictionValue"?: number, "zBase"?: number, "zHeight"?: number, "verticalForce"?: number, "affects"?: "ENEMIES"|"ALLIES"|"CASTER_ONLY"|"ALL" } }
